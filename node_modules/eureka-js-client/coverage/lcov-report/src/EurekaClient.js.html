  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>285/302</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>201/214</span>
      </div>
      <div class='fl pad1y'>
        <span class="strong">11 statements, 2 functions, 22 branches</span>
...
500
501
502</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
&nbsp;
    if (<span class="missing-if-branch" title="if path not taken" >I</span>typeof config.requestMiddleware !== 'function') {
      throw <span class="cstat-no" title="statement not covered" >new TypeError('requestMiddleware must be a function');</span>
    }
  }
&nbsp;
  /*
  ...
  startRegistryFetches() {
    this.registryFetch = setInterval(() =&gt; {
      this.fetchRegistry(<span class="fstat-no" title="function not covered" >err =&gt; {</span>
        if (<span class="cstat-no" title="statement not covered" >err) <span class="cstat-no" title="statement not covered" >this.logger.warn('Error fetching registries', err);</span></span>
      });
...
&nbsp;
  ...
  transformRegistry(registry) {
    if (<span class="missing-if-branch" title="if path not taken" >I</span>!registry) {
      this.<span class="cstat-no" title="statement not covered" >logger.warn('Unable to transform empty registry');</span>
    } else {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Oct 18 2016 18:28:00 GMT-0700 (PDT)
</div>
</div>
